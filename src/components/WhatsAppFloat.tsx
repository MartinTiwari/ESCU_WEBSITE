...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 bg-ink hover:bg-ink-soft text-amber-bright border border-amber-bright/40 rounded-full w-14 h-14 flex items-center justify-center shadow-lg transition-transform hover:scale-105"
    >
